...
class Config:
    ...
    def __init__(self):
        ...
        self.region_num = 10  # 下层区域的数量
        self.cs_num = 2  # 充电站的数量
        # 初始化
        ...
        # print(self.total_vehicle_vector)
        ...
        # print(self.region_id)
        # self.total_vehicle_vector1 = np.array(
        #     [191, 86, 180, 146, 92, 132, 123, 130, 106, 189, 102, 179, 196, 186, 182, 130, 162, 171, 153, 141])
        # print(self.total_vehicle_vector1)
        # self.total_vehicle_vector = np.array(
        #     [100, 100, 100, 100, 100, 132, 123, 130, 106, 189, 102, 179, 196, 186, 182, 130, 162, 171, 153, 141])

        # 横坐标是CS维度，纵坐标是区域维度  cs->region

        # self.total_dist_vector = np.array([[10,10,10,10,10,10,10,10],
        ...
        # self.total_dist_vector = np.array([[50, 30, 100, 137, 183, 30, 148, 71, 36, 88, 60, 23, 57, 197, 173, 190, 172,
        #                                      154, 25, 73],
        #                                     [69, 26, 193, 124, 81, 76, 96, 105, 47, 110, 101, 154, 28, 117, 94, 155,
        #                                      183, 147, 76, 113],
