...
'''
@Project ：EV_CS_edit 
@File    ：single_xij_pure_math.py
@Author  ：xxuanZhu
@Date    ：2021/6/9 11:27 
@Purpose : 利用纯数学的办法求解跳跃点区间的最大收益及最优定价
'''
...
def get_next_jump_p( dist, vehicle_num, copy_price, expression_dict, fij_symbol_list, q_symbol_list, lamuda_symbol_list, jump_point_list,
    ...
    ans = solve(expression_dict.values(),
                ...
                fij_symbol_list[0][0], fij_symbol_list[0][1], fij_symbol_list[0][2], fij_symbol_list[0][3],fij_symbol_list[0][4],fij_symbol_list[0][5], fij_symbol_list[0][6],fij_symbol_list[0][7],fij_symbol_list[0][8],fij_symbol_list[0][9],
                fij_symbol_list[1][0], fij_symbol_list[1][1], fij_symbol_list[1][2], fij_symbol_list[1][3],fij_symbol_list[1][4], fij_symbol_list[1][5],fij_symbol_list[1][6],fij_symbol_list[1][7],fij_symbol_list[1][8],fij_symbol_list[1][9],
                fij_symbol_list[2][0], fij_symbol_list[2][1], fij_symbol_list[2][2], fij_symbol_list[2][3],fij_symbol_list[2][4], fij_symbol_list[2][5],fij_symbol_list[2][6],fij_symbol_list[2][7],fij_symbol_list[2][8],fij_symbol_list[2][9],
                fij_symbol_list[3][0], fij_symbol_list[3][1], fij_symbol_list[3][2], fij_symbol_list[3][3], fij_symbol_list[3][4], fij_symbol_list[3][5],fij_symbol_list[3][6],fij_symbol_list[3][7],fij_symbol_list[3][8],fij_symbol_list[3][9],
                fij_symbol_list[4][0], fij_symbol_list[4][1], fij_symbol_list[4][2], fij_symbol_list[4][3],
                fij_symbol_list[4][4], fij_symbol_list[4][5],fij_symbol_list[4][6],fij_symbol_list[4][7],fij_symbol_list[4][8],fij_symbol_list[4][9],
                fij_symbol_list[5][0], fij_symbol_list[5][1], fij_symbol_list[5][2], fij_symbol_list[5][3],
                fij_symbol_list[5][4], fij_symbol_list[5][5],fij_symbol_list[5][6],fij_symbol_list[5][7],fij_symbol_list[5][8],fij_symbol_list[5][9],
    ...
    return jump_point_list[price_section_index], last_lower_0_flag,  last_min_p_queue, last_min_p_fij_queue, expression_dict, p_equal_flag, end_flag
