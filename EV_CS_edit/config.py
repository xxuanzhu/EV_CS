...
class Config:
    ...
    def __init__(self):
        ...
        # self.total_price = np.array([50, 60, 50, 40, 70, 65, 68, 74, 85, 48, 58])
        self.total_price = np.array([30, 90, 90, 90, 70, 65, 68, 74, 85, 48, 58])
        # self.total_vehicle_vector = np.array(
        #     [1690, 1732, 1943, 1988, 1981, 948, 1819, 1196, 737, 930, 1962, 1230, 1432, 1057, 886, 1818, 1541, 857, 535, 1405])
        self.total_vehicle_vector = np.array(
        ...
        self.region_num = 4 # 下层区域的数量
        self.cs_num = 6  # 充电站的数量

        # 根据充     电站数量和研究区域的数量截取相关环境数据
