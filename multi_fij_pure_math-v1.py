...
from jump_single.single_xij_pure_math import check_Q
...
def get_next_jump_p( dist, vehicle_num, copy_price, expression_dict, fij_symbol_list, q_symbol_list, lamuda_symbol_list, jump_point_list,
    ...
    ans = solve(expression_dict.values(),
                ...
                fij_symbol_list[0][4], fij_symbol_list[0][5], fij_symbol_list[0][6], fij_symbol_list[0][7],
                fij_symbol_list[0][8], fij_symbol_list[0][9],
                fij_symbol_list[1][0], fij_symbol_list[1][1], fij_symbol_list[1][2], fij_symbol_list[1][3],
                fij_symbol_list[1][4], fij_symbol_list[1][5], fij_symbol_list[1][6], fij_symbol_list[1][7],
                fij_symbol_list[1][8], fij_symbol_list[1][9],
                fij_symbol_list[2][0], fij_symbol_list[2][1], fij_symbol_list[2][2], fij_symbol_list[2][3],
                fij_symbol_list[2][4], fij_symbol_list[2][5], fij_symbol_list[2][6], fij_symbol_list[2][7],
                fij_symbol_list[2][8], fij_symbol_list[2][9],
                fij_symbol_list[3][0], fij_symbol_list[3][1], fij_symbol_list[3][2], fij_symbol_list[3][3],
                fij_symbol_list[3][4], fij_symbol_list[3][5], fij_symbol_list[3][6], fij_symbol_list[3][7],
                fij_symbol_list[3][8], fij_symbol_list[3][9],
                fij_symbol_list[4][0], fij_symbol_list[4][1], fij_symbol_list[4][2], fij_symbol_list[4][3],
                fij_symbol_list[4][4], fij_symbol_list[4][5], fij_symbol_list[4][6], fij_symbol_list[4][7],
                fij_symbol_list[4][8], fij_symbol_list[4][9],
                fij_symbol_list[5][0], fij_symbol_list[5][1], fij_symbol_list[5][2], fij_symbol_list[5][3],
                fij_symbol_list[5][4], fij_symbol_list[5][5], fij_symbol_list[5][6], fij_symbol_list[5][7],
                fij_symbol_list[5][8], fij_symbol_list[5][9],
    ...
    for item in points_dict.items():  # 有两种情况，分别是['-445']+['6789/4']
        if item[1][0] != []:  # 首先不能为空
            if '/' in item[1][0]:  # 如果待选值是分数，形式是['6789/4']
                ...
                list_value = round(int(nums_arr[0]) / int(nums_arr[1]))
                if list_value > copy_price[change_cs]:  # 待选值要大于当前的跳跃点
                    ...
                    if '/' in str(head):  # 如果最小的值也是分数形式
                        ...
                        res_head = round(int(nums_arr_head[0]) / int(nums_arr_head[1]))
